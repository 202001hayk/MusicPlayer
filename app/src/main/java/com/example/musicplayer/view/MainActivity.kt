...
/**
 * Created by Hayk Vardazaryan on 14/3/2023.
 */
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initialization() {
        ...
        binding.tvTotalSong.text = "Total Song : " + musicAdapter.itemCount
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        findViewById<LinearLayout>(R.id.lineatlayoutNav)?.setBackgroundResource(currentGradient[themeIndex])
